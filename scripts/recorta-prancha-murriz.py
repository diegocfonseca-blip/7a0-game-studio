# ─── ⚔️ RECORTE DA ARTE NOVA DO MURRIZ FC (16/09) ────────────────────────────
...
# Saída em /tmp/murriz/, com as provas sobre fundo CREME (nunca branco).
from PIL import Image
import numpy as np
from scipy import ndimage
import os

PRANCHA = '/root/.claude/uploads/15782737-58e2-54d9-971e-653cb64061f2/6d6fbcc8-image.png'
VERDE = (2, 249, 61)
os.makedirs('/tmp/murriz', exist_ok=True)
