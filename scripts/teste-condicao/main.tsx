...
// componente do jogo) com um elenco forjado e gás variado, pra conferir a
// barrinha, o "🏃 jogos", o selinho no boneco, o preparador e o banner do Guia.
...
const gas: Record<string, number> = { c0: 88, c1: 52, c2: 71, c3: 24, c4: 64, c5: 80, c6: 41, c7: 93, c8: 35, c9: 77, c10: 69, c11: 100, c12: 100, c13: 100, c14: 100, c15: 100, c16: 100, c17: 100 }
const jogos: Record<string, number> = { c0: 9, c1: 9, c2: 7, c3: 9, c4: 8, c5: 6, c6: 9, c7: 9, c8: 9, c9: 5, c10: 8, c11: 0, c12: 1, c13: 2, c14: 3, c15: 0, c16: 4, c17: 1 }
const goals: Record<string, number> = { c7: 14, c8: 19, c9: 11, c10: 9, c14: 6, c16: 8 }
const col = { solid: '#1B7A3D', light: '#CBEFD7' }

function Bancada() {
  return (
    <SquadTab mgr={mgr} col={col as never} coins={168} xiIds={new Set(xi.map(c => c.id))} xi={xi} goals={goals} assists={{}}
      onSwap={() => {}} selId={null} seasonNo={6} contratosOn={false} olheiros={false}
      condicao={{ gas, jogos, volta: id => (id === 'c16' ? -2 : 0), onRodizio: () => alert('rodiziar'), suspensoId: undefined }} />
  )
}
createRoot(document.getElementById('root')!).render(<EscProvider><Bancada /></EscProvider>)
