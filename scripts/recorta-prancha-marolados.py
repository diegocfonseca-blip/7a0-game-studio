...
# Saída em /tmp/marol/, com as provas sobre fundo CREME (nunca branco).
from PIL import Image
import numpy as np
from scipy import ndimage
import os

PRANCHA = '/root/.claude/uploads/15782737-58e2-54d9-971e-653cb64061f2/9a94f7c1-image.png'
VERDE = (2, 249, 61)
os.makedirs('/tmp/marol', exist_ok=True)
