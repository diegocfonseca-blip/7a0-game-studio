...
const JOGADORES = [
  ...
  { n: 'Vinícius Júnior',     club: 'Real Madrid',    ano: 2024, f: 5, pele: 'd', cabelo: 'tranca',   cc: PRETO,    barba: 'cavan',  c1: '#FFFFFF', c2: '#C9A227', tipo: 'lisa' },
  { n: 'Lionel Messi',        club: 'Barcelona',      ano: 2012, f: 5, pele: 'a', cabelo: 'curto',    cc: CASTANHO, barba: 'nao',    c1: '#A50044', c2: '#143A87', tipo: 'listras' },
  { n: 'Ronaldinho Gaúcho',   club: 'Barcelona',      ano: 2005, f: 5, pele: 'd', cabelo: 'longo',    cc: PRETO,    barba: 'nao',    c1: '#A50044', c2: '#143A87', tipo: 'listras' },
  { n: 'Kaká',                club: 'Milan',          ano: 2007, f: 5, pele: 'a', cabelo: 'curto',    cc: CASTANHO, barba: 'nao',    c1: '#B3132A', c2: '#0C0C0C', tipo: 'listras' },
  { n: 'Zinedine Zidane',     club: 'Real Madrid',    ano: 2002, f: 5, pele: 'b', cabelo: 'careca',   cc: GRISALHO, barba: 'nao',    c1: '#FFFFFF', c2: '#C9A227', tipo: 'lisa' },
