...
// ─── PROPOSTA ────────────────────────────────────────────────────────────────
const proposta = `
<div class="fita">T25 · Rodada 3/38 · Várzea &nbsp;·&nbsp; <b>2 × 1</b> FIM <span class="cv">▾</span></div>
...
<div class="alerta"><span class="ae">🚑</span><span class="at"><b>9 jogadores esgotados</b><i>gás do time 29% — o elenco precisa de banco</i></span></div>
<div class="listas">
  <p class="lt">⭐ TITULARES (11)</p>
  ${ELENCO.map(j => jog(...j)).join('')}
  <p class="mais">… e mais 6</p>
</div>
<div class="depois">⬇️ campinho, formação e <b>tática</b> continuam logo abaixo —<br>mas o ELENCO, que é o que a aba promete, vem primeiro</div>`
...
<p class="sub">Hoje são <b>quatro fileiras de botão iguais</b> com significados diferentes — ritmo, ação, navegação e tática — e o <b>elenco</b>, que é o que a aba promete, fica a duas telas de distância. A regra da proposta é simples: <b>a forma segue o papel</b>.</p>
<div class="grid">
...
<div class="nota">
  ...
  · <b>O bloco da partida vira uma faixa</b> quando você está no Elenco (toca nela pra abrir o placar inteiro). Sozinho isso devolve meia tela.<br>
  ...
  · <b>A tática desce pro pé da página</b>, junto do campinho: ela é do TIME, não do topo da tela.<br>
  · <b>Entra a faixa 🚑</b> com o que está doendo agora ("9 jogadores esgotados"), logo antes da lista — o aviso encosta no problema.
</div>`
