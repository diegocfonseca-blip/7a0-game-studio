#!/usr/bin/env python3
# 🐆👑 RECORTE DA PRANCHA DO GRÊMIO FBPA (danieldias11, batismo de 21/09).
#
...
# 🎯 a cor EXATA do fundo (a mais comum da prancha, medida: 3,247,82)
ref = np.array([3, 247, 82])
...
def salvaMascara(mascara, nome):
    ...
    out.save(f'/tmp/gremio-{nome}.png')
...
print('\n✅ peças cruas em /tmp/gremio-*.png (o redimensionar e o webp vêm depois)')
