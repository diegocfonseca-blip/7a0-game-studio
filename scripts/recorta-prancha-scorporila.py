...
# Saída em /tmp/scorp/, com as provas sobre fundo CREME (nunca branco).
from PIL import Image
import numpy as np
from scipy import ndimage
import os

PRANCHA = '/root/.claude/uploads/15782737-58e2-54d9-971e-653cb64061f2/939ff6d1-image.png'
VERDE = (2, 249, 61)
os.makedirs('/tmp/scorp', exist_ok=True)
