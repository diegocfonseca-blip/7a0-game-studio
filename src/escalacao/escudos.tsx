...
// 📍⚫🟡 Futpoint FC (gfpicolo13) — ex-Serrano FC, Série B. Escudo preto/dourado
// com o alfinete de mapa e a bola dentro, faixa com o nome e "EST. 2024". Arte
// enviada pelo próprio dono; aqui só tiramos o fundo branco, cortamos no limite
// do desenho e reduzimos (o escudo nunca passa de 78px na tela).
...
export const LOGOS_PRONTAS: Record<string, (size: number) => ReactNode> = {
  ...
  // 📍⚫🟡 Futpoint FC (gfpicolo13) — ex-Serrano FC, Série B. O nome velho fica
  // registrado: quem já tinha carreira com o Serrano não fica sem escudo.
  'Futpoint FC': futpointEscudoRender,
  'Futpoint': futpointEscudoRender,
  'FutPoint FC': futpointEscudoRender,
  'Fut Point FC': futpointEscudoRender,
  'Serrano FC': futpointEscudoRender,
  ...
  // ⬇️ kit de batismo (arte própria em código — cores + símbolo folclórico, sem escudo real)
  'Império Samambaia': (size: number) => {
    const w = Math.round(size * 200 / 240)
    return (
      <svg width={w} height={size} viewBox="0 0 200 240" aria-label="Império Samambaia" role="img" style={{ flex: 'none', display: 'block' }}>
        <defs><clipPath id="smSam"><path d="M18 30 H182 V145 C182 188 138 214 100 234 C62 214 18 188 18 145 Z"/></clipPath></defs>
              <path d="M18 30 H182 V145 C182 188 138 214 100 234 C62 214 18 188 18 145 Z" fill="#FFFFFF"/>
              <g clipPath="url(#smSam)"><rect x="-60" y="-60" width="320" height="360" fill="#FFFFFF"/><g transform="rotate(-38 100 130)"><rect x="-120" y="-60" width="26" height="360" fill="#E5271C"/><rect x="-68" y="-60" width="26" height="360" fill="#E5271C"/><rect x="-16" y="-60" width="26" height="360" fill="#E5271C"/><rect x="36" y="-60" width="26" height="360" fill="#E5271C"/><rect x="88" y="-60" width="26" height="360" fill="#E5271C"/><rect x="140" y="-60" width="26" height="360" fill="#E5271C"/><rect x="192" y="-60" width="26" height="360" fill="#E5271C"/><rect x="244" y="-60" width="26" height="360" fill="#E5271C"/><rect x="296" y="-60" width="26" height="360" fill="#E5271C"/></g></g>
              <path d="M18 30 H182 V145 C182 188 138 214 100 234 C62 214 18 188 18 145 Z" fill="none" stroke="#0C0C0C" strokeWidth="7" strokeLinejoin="round"/>
              <g clipPath="url(#smSam)">
                <path d="M100.0 150.0 Q77.7 127.9 47.4 119.6" fill="none" stroke="#0F5528" strokeWidth="4.6" strokeLinecap="round"/><ellipse cx="92.5" cy="137.7" rx="15.0" ry="6.3" transform="rotate(-106.0 92.5 137.7)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="88.0" cy="148.7" rx="15.0" ry="6.3" transform="rotate(150.0 88.0 148.7)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="84.8" cy="132.0" rx="13.6" ry="5.7" transform="rotate(-106.0 84.8 132.0)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="80.8" cy="142.0" rx="13.6" ry="5.7" transform="rotate(150.0 80.8 142.0)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="76.7" cy="127.1" rx="12.1" ry="5.1" transform="rotate(-106.0 76.7 127.1)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="73.2" cy="136.0" rx="12.1" ry="5.1" transform="rotate(150.0 73.2 136.0)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="68.2" cy="123.0" rx="10.7" ry="4.5" transform="rotate(-106.0 68.2 123.0)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="65.1" cy="130.8" rx="10.7" ry="4.5" transform="rotate(150.0 65.1 130.8)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="59.3" cy="119.6" rx="9.2" ry="3.9" transform="rotate(-106.0 59.3 119.6)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="56.6" cy="126.3" rx="9.2" ry="3.9" transform="rotate(150.0 56.6 126.3)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="49.9" cy="116.9" rx="7.8" ry="3.3" transform="rotate(-106.0 49.9 116.9)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="47.7" cy="122.6" rx="7.8" ry="3.3" transform="rotate(150.0 47.7 122.6)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="47.4" cy="119.6" rx="8.0" ry="3.5" transform="rotate(-150.0 47.4 119.6)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><path d="M100.0 150.0 Q85.9 115.9 58.6 90.9" fill="none" stroke="#0F5528" strokeWidth="4.6" strokeLinecap="round"/><ellipse cx="97.6" cy="134.5" rx="15.0" ry="6.3" transform="rotate(-81.0 97.6 134.5)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="88.9" cy="142.6" rx="15.0" ry="6.3" transform="rotate(175.0 88.9 142.6)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="92.0" cy="124.7" rx="13.6" ry="5.7" transform="rotate(-81.0 92.0 124.7)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="84.2" cy="132.0" rx="13.6" ry="5.7" transform="rotate(175.0 84.2 132.0)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="85.7" cy="115.3" rx="12.1" ry="5.1" transform="rotate(-81.0 85.7 115.3)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="78.7" cy="121.8" rx="12.1" ry="5.1" transform="rotate(175.0 78.7 121.8)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="78.6" cy="106.4" rx="10.7" ry="4.5" transform="rotate(-81.0 78.6 106.4)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="72.5" cy="112.1" rx="10.7" ry="4.5" transform="rotate(175.0 72.5 112.1)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="70.9" cy="98.0" rx="9.2" ry="3.9" transform="rotate(-81.0 70.9 98.0)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="65.6" cy="103.0" rx="9.2" ry="3.9" transform="rotate(175.0 65.6 103.0)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="62.5" cy="90.1" rx="7.8" ry="3.3" transform="rotate(-81.0 62.5 90.1)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="58.0" cy="94.3" rx="7.8" ry="3.3" transform="rotate(175.0 58.0 94.3)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="58.6" cy="90.9" rx="8.0" ry="3.5" transform="rotate(-125.0 58.6 90.9)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><path d="M100.0 150.0 Q101.3 111.2 86.8 75.3" fill="none" stroke="#0F5528" strokeWidth="4.6" strokeLinecap="round"/><ellipse cx="104.3" cy="134.5" rx="15.0" ry="6.3" transform="rotate(-56.0 104.3 134.5)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="93.0" cy="138.2" rx="15.0" ry="6.3" transform="rotate(-160.0 93.0 138.2)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="103.3" cy="122.6" rx="13.6" ry="5.7" transform="rotate(-56.0 103.3 122.6)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="93.1" cy="125.9" rx="13.6" ry="5.7" transform="rotate(-160.0 93.1 125.9)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="101.4" cy="110.8" rx="12.1" ry="5.1" transform="rotate(-56.0 101.4 110.8)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="92.3" cy="113.8" rx="12.1" ry="5.1" transform="rotate(-160.0 92.3 113.8)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="98.7" cy="99.2" rx="10.7" ry="4.5" transform="rotate(-56.0 98.7 99.2)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="90.7" cy="101.8" rx="10.7" ry="4.5" transform="rotate(-160.0 90.7 101.8)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="95.1" cy="87.7" rx="9.2" ry="3.9" transform="rotate(-56.0 95.1 87.7)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="88.2" cy="89.9" rx="9.2" ry="3.9" transform="rotate(-160.0 88.2 89.9)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="90.7" cy="76.4" rx="7.8" ry="3.3" transform="rotate(-56.0 90.7 76.4)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="84.8" cy="78.3" rx="7.8" ry="3.3" transform="rotate(-160.0 84.8 78.3)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="86.8" cy="75.3" rx="8.0" ry="3.5" transform="rotate(-100.0 86.8 75.3)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><path d="M100.0 150.0 Q114.5 114.0 113.2 75.3" fill="none" stroke="#0F5528" strokeWidth="4.6" strokeLinecap="round"/><ellipse cx="109.3" cy="136.9" rx="15.0" ry="6.3" transform="rotate(-36.0 109.3 136.9)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="97.5" cy="136.5" rx="15.0" ry="6.3" transform="rotate(-140.0 97.5 136.5)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="112.4" cy="125.3" rx="13.6" ry="5.7" transform="rotate(-36.0 112.4 125.3)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="101.7" cy="125.0" rx="13.6" ry="5.7" transform="rotate(-140.0 101.7 125.0)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="114.7" cy="113.6" rx="12.1" ry="5.1" transform="rotate(-36.0 114.7 113.6)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="105.2" cy="113.3" rx="12.1" ry="5.1" transform="rotate(-140.0 105.2 113.3)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="116.1" cy="101.8" rx="10.7" ry="4.5" transform="rotate(-36.0 116.1 101.8)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="107.7" cy="101.5" rx="10.7" ry="4.5" transform="rotate(-140.0 107.7 101.5)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="116.7" cy="89.8" rx="9.2" ry="3.9" transform="rotate(-36.0 116.7 89.8)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="109.4" cy="89.5" rx="9.2" ry="3.9" transform="rotate(-140.0 109.4 89.5)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="116.4" cy="77.6" rx="7.8" ry="3.3" transform="rotate(-36.0 116.4 77.6)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="110.3" cy="77.4" rx="7.8" ry="3.3" transform="rotate(-140.0 110.3 77.4)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="113.2" cy="75.3" rx="8.0" ry="3.5" transform="rotate(-80.0 113.2 75.3)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><path d="M100.0 150.0 Q127.2 125.1 141.4 90.9" fill="none" stroke="#0F5528" strokeWidth="4.6" strokeLinecap="round"/><ellipse cx="113.7" cy="142.4" rx="15.0" ry="6.3" transform="rotate(-11.0 113.7 142.4)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="103.2" cy="137.1" rx="15.0" ry="6.3" transform="rotate(-115.0 103.2 137.1)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="121.1" cy="133.8" rx="13.6" ry="5.7" transform="rotate(-11.0 121.1 133.8)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="111.5" cy="128.9" rx="13.6" ry="5.7" transform="rotate(-115.0 111.5 128.9)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="127.7" cy="124.7" rx="12.1" ry="5.1" transform="rotate(-11.0 127.7 124.7)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="119.2" cy="120.3" rx="12.1" ry="5.1" transform="rotate(-115.0 119.2 120.3)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="133.7" cy="115.0" rx="10.7" ry="4.5" transform="rotate(-11.0 133.7 115.0)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="126.2" cy="111.2" rx="10.7" ry="4.5" transform="rotate(-115.0 126.2 111.2)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="138.9" cy="104.9" rx="9.2" ry="3.9" transform="rotate(-11.0 138.9 104.9)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="132.4" cy="101.6" rx="9.2" ry="3.9" transform="rotate(-115.0 132.4 101.6)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="143.4" cy="94.3" rx="7.8" ry="3.3" transform="rotate(-11.0 143.4 94.3)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="138.0" cy="91.5" rx="7.8" ry="3.3" transform="rotate(-115.0 138.0 91.5)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="141.4" cy="90.9" rx="8.0" ry="3.5" transform="rotate(-55.0 141.4 90.9)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><path d="M100.0 150.0 Q130.3 141.7 152.6 119.6" fill="none" stroke="#0F5528" strokeWidth="4.6" strokeLinecap="round"/><ellipse cx="114.5" cy="149.6" rx="15.0" ry="6.3" transform="rotate(14.0 114.5 149.6)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="107.2" cy="140.3" rx="15.0" ry="6.3" transform="rotate(-90.0 107.2 140.3)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="123.2" cy="145.8" rx="13.6" ry="5.7" transform="rotate(14.0 123.2 145.8)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="116.6" cy="137.4" rx="13.6" ry="5.7" transform="rotate(-90.0 116.6 137.4)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="131.4" cy="141.3" rx="12.1" ry="5.1" transform="rotate(14.0 131.4 141.3)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="125.5" cy="133.8" rx="12.1" ry="5.1" transform="rotate(-90.0 125.5 133.8)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="139.3" cy="136.0" rx="10.7" ry="4.5" transform="rotate(14.0 139.3 136.0)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="134.1" cy="129.4" rx="10.7" ry="4.5" transform="rotate(-90.0 134.1 129.4)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="146.7" cy="130.0" rx="9.2" ry="3.9" transform="rotate(14.0 146.7 130.0)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="142.2" cy="124.2" rx="9.2" ry="3.9" transform="rotate(-90.0 142.2 124.2)" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="153.7" cy="123.2" rx="7.8" ry="3.3" transform="rotate(14.0 153.7 123.2)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="149.9" cy="118.4" rx="7.8" ry="3.3" transform="rotate(-90.0 149.9 118.4)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/><ellipse cx="152.6" cy="119.6" rx="8.0" ry="3.5" transform="rotate(-30.0 152.6 119.6)" fill="#1F8A46" stroke="#0C0C0C" strokeWidth="2.5"/>
                <ellipse cx="100" cy="150" rx="42" ry="40" fill="#3AAE63" stroke="#0C0C0C" strokeWidth="6"/>
                <path d="M64 150 Q64 120 100 116 Q136 120 136 150" fill="#1F8A46" opacity=".5"/>
                <g transform="translate(100 146) scale(1.18)">
              ...
              <path d="M-16 27 L-11 33 -6 27 -1 33 4 27 9 33 14 27" fill="#fff" stroke="#0C0C0C" strokeWidth="1.5"/>
                ...
                <path d="M76.0 120.0 L76.0 102.7 L89.9 114.2 L100.0 96.0 L110.1 114.2 L124.0 102.7 L124.0 120.0 Z" fill="#FFC400" stroke="#0C0C0C" strokeWidth="3.4" strokeLinejoin="round"/><rect x="76.0" y="120.0" width="48.0" height="8.2" rx="2.9" fill="#FFC400" stroke="#0C0C0C" strokeWidth="3.4"/><circle cx="100.0" cy="105.1" r="4.3" fill="#E5271C" stroke="#0C0C0C" strokeWidth="1.6"/><circle cx="76.0" cy="102.7" r="2.9" fill="#FFFFFF" stroke="#0C0C0C" strokeWidth="1.4"/><circle cx="124.0" cy="102.7" r="2.9" fill="#FFFFFF" stroke="#0C0C0C" strokeWidth="1.4"/>
              </g>
      </svg>
    )
  },
