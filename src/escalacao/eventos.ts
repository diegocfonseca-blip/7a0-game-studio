...
const BALADEIROS = new Set([
  ...
  'Renato Gaúcho', 'Loco Abreu', 'Neymar', 'Zé Love',
  // 🌍 Europa/mundo
  'Mario Balotelli',
  // 🎪 folclóricos inventados do jogo (zoeira 100% livre)
...
const PAVIO_CURTO = new Set([
  ...
  'Zlatan Ibrahimović', 'Suárez', 'Luis Suárez',
...
export function sorteiaEvento(args: {
  ...
  const { seed, seasonNo, round, xi, squad, temMedico } = args
