...
export const MANTO_CONTAS: Record<string, [string, string]> = {
  ...
  'duselecta@gmail.com': ['#101210', '#F1C02C'], // 🔊 Bonança SSFC — preto e amarelo, MEDIDOS na camisa que o dono mandou (mediana dos pretos, 80% do manto, e dos amarelos das listras rasta, 09/09). O VERMELHO é a 3ª cor (MANTO_TRI); o verde da bandeira fica no escudo · ❤️ torce pro SÃO PAULO (o Diego confirmou em 19/09; está em `esc_socios.time_coracao`)
  'matheus223lms@icloud.com': ['#0040CD', '#040609'], // 🪩 Inter de Bailão — azul e preto, MEDIDOS na camisa que o dono mandou (mediana de 21.126 px do azul e 32.119 px do preto no corpo da camisa, 14/09)
  'matheusstefanello372@gmail.com': ['#A90605', '#FCF6F1'], // 👑 Internacional de Madrid — vermelho e branco, MEDIDOS na arte que o dono mandou (mediana de 13.309 px do vermelho da camisa e 41.238 px do branco, 14/09)
  'marcomak03@gmail.com': ['#033E23', '#ECEAD4'], // 😇🐷 São Marcos Antônio FC — verde-garrafa e creme, MEDIDOS na camisa que o dono mandou (mediana dos verdes, 79% do manto, e dos claros das listras/mangas, 13/09)
  ...
  'portaltech.ep@gmail.com': ['#030A04', '#597751'], // 🌑🐺 Pesadelo Verde FC — quase-preto e verde-musgo, MEDIDOS na camisa que o dono mandou (escuro 84% do manto, verde 7%, 18/09). O ESCURO vem primeiro porque é o que domina a camisa e porque listra clara na tela creme some. O BRANCO #D8D6D1 da gola e dos punhos é a 3ª cor (MANTO_TRI). ❤️ Palmeiras (o Diego confirmou em 19/09)
  'eltonfrossard45@gmail.com': ['#011B8A', '#E8E8EB'], // 🦊 La Bestia Negra — azul e branco, MEDIDOS na camisa NOVA que o dono mandou (18/09; o azul é a leitura do PANO, p65-p75 do brilho — a mediana crua puxava pro quase-preto por causa do sombreado pesado da arte). ⚠️ ANTES o manto dele vinha só do banco, com `#0E3E86` + `#F4ECD6` — e essa 2ª cor é EXATAMENTE o creme da tela do jogo, ou seja a listra clara sumia no fundo. Agora a 2ª cor é o branco de verdade da camisa. ❤️ Cruzeiro (as 5 estrelas estão no escudo e na camisa)
  'luiz.maia.luiz@gmail.com': ['#072246', '#F8F8F8'], // 🦁⚡ Remoçada — azul-marinho e branco, MEDIDOS na camisa que o dono mandou (18/09; o azul é a leitura do PANO nos ombros, longe da sombra do leão estampado — a mediana crua dava #031936, quase preto, porque a arte tem sombreado pesado). O azul é 86% do manto e o branco 4% (gola, punhos e as duas listras da manga). ❤️ Clube do Remo (o Leão Azul do norte). SEM 3ª cor: o vermelho é da CAPA da mascote, não da camisa
  'felipe.ofrida@gmail.com': ['#161616', '#D5D5D5'], // 🐴 Fridão FC — preto e branco, MEDIDOS na camisa que o dono mandou (preto 65% do manto, branco 15%, 16/09). O PRETO vem primeiro porque listra clara na tela creme SOME (mesma ordem do Tricolor do Arruda, do Briga de Galo e do Nightfull). Listras VERTICAIS, que é o padrão — sem linha no MANTO_ANGLE. SEM 3ª cor: o amarelo da bola e do escudinho é o PATROCÍNIO ("Meia na Canela"), não cor de manto, e dá 0,7% da camisa
  ...
  'igormarquesn99@gmail.com': ['#AE1A13', '#F3B212'], // 🌽 Milhaça FC — vermelho e amarelo, MEDIDOS na camisa que o dono mandou (24/08) ❤️ São Paulo (o Diego confirmou em 19/09)
...
const MANTO_TRI: Record<string, string> = {
  ...
  pesadelo_lobo: '#D8D6D1', // 🌑🐺 Pesadelo Verde FC (portaltech.ep) — 3ª cor BRANCA: a gola, os punhos e o filete da camisa (medida na arte do dono, 18/09)
