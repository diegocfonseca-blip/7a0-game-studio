...
export function EscMonte() {
  ...
  return (
    <Shell bar={<AuctionBar />}>
      ...
      {online && (
        <p className="text-xs font-semibold text-black/60">
          ⏱️ {remaining ?? (state.careerOnline ? MONTE_SECONDS_CARREIRA : MONTE_SECONDS)}s por vez. {state.careerOnline
