  ...
  return (
    <Box bg="#F6F2FF" className="p-4 space-y-3">
      ...
      <div>
        ...
        <p className="text-xs font-bold text-black/75 mt-1"><b>🇧🇷 BR:</b> Enner Valencia, Alan Patrick, Bernabei (reforços do Inter), Kaio Jorge, Neilton 💎, GarrinSha 🃏, Paulinho (atacante), Reinier 🃏, <b>Evaristo de Macedo 👑</b>, Donizete Pantera, Oséas, Luciano, Caio Ribeiro 💎, Galeano, Cláudio Pitbull, Souza, Rodrigo Souto, Domingos, Rogério (pedala Robinho) 🃏, Matheus Pereira, <b>Ademir de Menezes 👑</b>, Nelinho, Éder, Dirceu, César Sampaio, Luizão, Waldir Peres, Josimar, <b>Figueroa 👑</b>, Bolívar, Índio, Alexandre Pato 💎.</p>
