...
export function SupportStory() {
  return <section className="ll-support-story">
    ...
    <p>{tr('E faço por um motivo com nome: o Luca, meu filho. Ele tem uma condição rara — e é o menino mais forte que eu conheço. Cada apoio vira uma vida melhor pro Luca e este jogo vivo, crescendo toda semana.', 'And I do it for a reason with a name: Luca, my son. He has a rare condition — and he is the strongest boy I know. Every bit of support helps give Luca a better life and keeps this game alive, growing every week.')}</p>
