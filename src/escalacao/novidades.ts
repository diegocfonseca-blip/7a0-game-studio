...
export const NOVIDADES: Novidade[] = [
  { data: '2026-08-30', emoji: '🐦‍⬛', titulo: 'O Manfré FC ganhou cara nova', texto: 'O dono mandou a arte dele e o clube trocou de pele: escudo, mascote e manto novos — a Gralha agora carimba a tela quando o time faz gol, e o manto virou vermelho e azul. Mesma vaga na Série D, mesmo elenco, mesmo tudo: quem já tinha carreira com o Manfré FC (ou com o antigo Livre-pool) continua no mesmo time, só com a cara nova.' },
