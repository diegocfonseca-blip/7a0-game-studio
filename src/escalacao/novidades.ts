...
export const NOVIDADES: Novidade[] = [
  ...
  { data: '2026-08-23', emoji: '📺', titulo: 'A TV agora paga cota extra pelo seu vídeo', texto: 'No Modo Carreira: a Rede Martelo TV ganhou casa fixa em Clube › Patrocínio — lá dá pra ver quanto o contrato da sua divisão paga por temporada e televisionar seu jogo: grava um vídeo (15s+) da tela jogando, posta no Instagram ou TikTok marcando @leilaolegendscom, cola o link e ganha +15 moedas na caixa do clube. Um vídeo por temporada — e, como toda cota de TV, pode atrasar um pouquinho, mas cai.' },
