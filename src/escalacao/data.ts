...
const LAT: C[] = [
  ...
  { name: "Leonardo", club: "São Paulo", year: 1992, fame: 4, lo: 80, hi: 84 },
...
const MEI: C[] = [
  ...
  { name: "Juninho Paulista", club: "São Paulo", year: 2009, fame: 4, lo: 79, hi: 84 },
  ...
  { name: "Renato Augusto", club: "Corinthians", year: 2018, fame: 4, lo: 78, hi: 84 },
  ...
  { name: "Valdivia", club: "Palmeiras", year: 2013, fame: 4, lo: 60, hi: 84, folk: true },
...
const ATA: C[] = [
  ...
  { name: "Cláudio Pitbull", club: "Coritiba", year: 2010, fame: 2, lo: 66, hi: 80 },
  ...
  { name: "Paulinho", club: "Atlético-MG", year: 2022, fame: 3, lo: 78, hi: 86, bio: "Centroavante artilheiro que explodiu no Atlético-MG — força, velocidade e faro de gol que renderam a Seleção e a ida pra Europa. (Não confundir com o volante Paulinho do Corinthians!)" },
  ...
  { name: "Grafite", club: "São Paulo", year: 2008, fame: 4, lo: 78, hi: 84 },
...
const NOVOS_BR_ATA: C[] = [
  ...
  { name: 'Paulinho Bóia', club: 'São Paulo', year: 2019, fame: 1, lo: 54, hi: 75, folk: true, bio: 'Ponta cria do São Paulo de apelido folclórico — velocidade pelos lados.' },
...
const ATA_WORLD: C[] = [
  ...
  { name: "Hwang Sun-hong", club: "Pohang Steelers", year: 2002, fame: 3, lo: 68, hi: 83, bio: "Matador coreano — abriu o placar contra a Polônia em 2002: a PRIMEIRA vitória da Coreia em Copas." },
...
const NOVOS_WORLD_LAT: C[] = [
  ...
  { name: 'Pierre Womé', club: 'Inter', year: 2003, fame: 2, lo: 64, hi: 80, bio: 'Lateral canhoto potente de Camarões, veterano da Inter e do Bologna.' },
...
const NOVOS_WORLD_MEI: C[] = [
  ...
  { name: 'Carlos Paredes', club: 'Porto', year: 2004, fame: 2, lo: 66, hi: 81, bio: 'Volante paraguaio de motor infinito — Porto, Reggina e três Copas.' },
...
export const DIVISION_TEAMS: Record<'A' | 'B' | 'C' | 'D', CareerTeam[]> = {
  ...
  A: [
    ...
    { name: 'Gabriel', team: 'Desportivo Montreal' }, // ⚽ clube BATIZADO por apoiador (nevesgabriel95 — Desportivo Montreal, ex-Titan Capital; Lenda + fundador, 11/08)
