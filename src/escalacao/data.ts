...
const ZAG_EU: C[] = [
  ...
  { name: "Aymeric Laporte", club: "Man City", year: 2021, fame: 3, lo: 81, hi: 88, bio: "Zagueiro canhoto de saída de bola refinada — peça dos títulos do City de Guardiola antes de defender a Espanha." },
...
const ATA_EU: C[] = [
  ...
  { name: "Márcio Amoroso", club: "Dortmund", year: 2002, fame: 3, lo: 80, hi: 86 },
