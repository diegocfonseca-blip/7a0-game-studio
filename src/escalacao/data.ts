...
const GOL: C[] = [
  ...
  { name: "Júlio César", club: "Flamengo", year: 2003, fame: 3, lo: 78, hi: 84 },
...
const ATA: C[] = [
  ...
  { name: "Paulinho", club: "Atlético-MG", year: 2024, fame: 3, lo: 78, hi: 86, bio: "Centroavante artilheiro que explodiu no Atlético-MG — força, velocidade e faro de gol que renderam a Seleção e a ida pra Europa. (Não confundir com o volante Paulinho do Corinthians!)" },
  ...
  { name: "Washington Coração Valente", club: "Atlético-PR", year: 2004, fame: 3, lo: 76, hi: 84 },
...
const MEI_EU: C[] = [
  ...
  { name: "Mario Götze", club: "Bayern", year: 2014, fame: 3, lo: 74, hi: 86 },
