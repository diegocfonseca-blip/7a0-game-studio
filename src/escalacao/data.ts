...
export const BIOS: Record<string, string> = {
  ...
  "Ousmane Dembélé": "Campeão do mundo com a França em 2018 e Bola de Ouro — drible dos dois pés e velocidade elétrica, o ponta que explodiu no PSG.",
...
const MEI: C[] = [
  ...
  { name: "Ademir da Guia", club: "Palmeiras", year: 1972, fame: 5, lo: 88, hi: 94 },
...
const ATA: C[] = [
  ...
  { name: "Marta", club: "Santos", year: 2009, fame: 5, lo: 84, hi: 89 },
...
// 🪵 CATEGORIA: FOI PROFISSIONAL (fame 1) — **decisão do Diego em 15/09**: *"Leo
// Maringá coloca como foi profissional"*. Ele tinha nascido como 🎯 Bom Jogador
// (fame 2) e o Diego reclassificou; quem manda na categoria é ele.
// ⚠️ O NÍVEL NÃO MUDOU (62-80): essa faixa já é usada por outras cartas fame 1, então
// a carta continua valendo o mesmo em campo — só trocou de categoria (e de cor).
...
const GOL_EU: C[] = [
  ...
  { name: "Petr Čech", club: "Chelsea", year: 2005, fame: 5, lo: 84, hi: 90 },
  ...
  { name: "Edwin van der Sar", club: "Man United", year: 2009, fame: 5, lo: 85, hi: 91, bio: "O holandês gigante do United campeão da Champions — recorde de minutos sem tomar gol e frieza total nas decisões." },
...
const ZAG_EU: C[] = [
  ...
  { name: "Fernando Hierro", club: "Real Madrid", year: 1998, fame: 5, lo: 84, hi: 90 },
...
const MEI_EU: C[] = [
  ...
  { name: "Paul Scholes", club: "Man United", year: 2003, fame: 5, lo: 85, hi: 91 },
  ...
  { name: "Michael Laudrup", club: "Barcelona", year: 1992, fame: 5, lo: 85, hi: 91 },
  { name: "Fernando Redondo", club: "Real Madrid", year: 1999, fame: 5, lo: 84, hi: 90 },
  ...
  { name: "Bastian Schweinsteiger", club: "Bayern", year: 2013, fame: 5, lo: 85, hi: 91, bio: "O 'Fussballgott' — volante-cérebro do Bayern da tríplice coroa e campeão do mundo com a Alemanha em 2014." },
...
const ATA_EU: C[] = [
  ...
  { name: "Thomas Müller", club: "Bayern", year: 2014, fame: 5, lo: 83, hi: 90 },
  ...
  { name: "Eden Hazard", club: "Chelsea", year: 2015, fame: 5, lo: 86, hi: 92 },
  ...
  { name: "Miroslav Klose", club: "Bayern", year: 2007, fame: 5, lo: 82, hi: 88 },
  ...
  { name: "Ousmane Dembélé", club: "PSG", year: 2024, fame: 5, lo: 85, hi: 91 },
...
const L27_EU_ATA: C[] = [
  { name: 'Donyell Malen', club: 'Roma', year: 2026, fame: 3, lo: 76, hi: 86, bio: 'Centroavante holandês que chegou à Roma emprestado e engatou 15 gols em 20 jogos — a compra virou obrigação.' },
]
const L27_EU_ZAG: C[] = [
...
const GOL_WORLD: C[] = [
  ...
  { name: "René Higuita", club: "Atlético Nacional", year: 1990, fame: 5, lo: 85, hi: 92, folk: true, bio: "O goleiro-líbero colombiano do escorpião em Wembley — saía driblando na área como um camisa 10. Ousadia e loucura em pessoa." },
  { name: "José Luis Chilavert", club: "Vélez Sarsfield", year: 1998, fame: 5, lo: 83, hi: 90, folk: true, bio: "O goleiro paraguaio que batia falta e pênalti e FAZIA gol — mais de 60 na carreira. Personalidade explosiva e mira de artilheiro." },
...
export const OLD_NAME: Record<string, string> = {
  ...
  'Pesadelo Verde FC': 'Zé Colmeia', // 🌑🐺 batismo do portaltech.ep (18/09): assumiu o assento da Série C que era do Zé Colmeia — save antigo com Zé Colmeia vira Pesadelo Verde FC ao abrir. (O Zé Colmeia continua existindo na lista morta CPU_MANAGERS; só o assento da pirâmide mudou de nome.)
...
export const DIVISION_TEAMS: Record<'A' | 'B' | 'C' | 'D', CareerTeam[]> = {
  ...
  B: [
    ...
    // ⚽ Barcenite FC (ricardopessoafreire) DESCEU da Série A pra cá em 10/09, por
    // decisão do Diego, pra abrir o assento do Leite de Verdade FC. Ocupa a vaga que
    // era do bot "Marítimo do Recôncavo" (escolhido por só existir aqui e em
    // CLASSIC_CLUBS, em mais lugar nenhum do jogo) — e era o bot mais FORTE nessa
    // condição, que é o justo pra quem vem da Série A.
    // ⚠️ DE PROPÓSITO **não** existe `OLD_NAME['Barcenite FC'] = 'Marítimo do Recôncavo'`:
    // ele não foi renomeado, só mudou de divisão — o nome velho dele (Milanesa FC)
    // segue valendo.
    { name: 'Piu do Grêmio', team: 'Barcenite FC' }, // ⚽ clube BATIZADO por apoiador (ricardopessoafreire — Barcenite FC, ex-Milanesa FC; fundador nº31). Escudo, mascote e manto seguem os dele, sem mudança nenhuma.
    ...
    { name: 'Painitto', team: 'SC Ferrari' }, // ⚽ clube BATIZADO por apoiador (adriano.ferrari — SC Ferrari, ex-Painitto FC). ⬇️ DESCEU da Série A em 21/09, por decisão do Diego, pra abrir a vaga do Grêmio FBPA. Assento que era do 🤖 Comercial das Gerais — que continua existindo em CLASSIC_CLUBS e na lista morta de CPU; só perdeu o lugar na pirâmide. ⚠️ SEM OLD_NAME novo: o Ferrari não foi renomeado, a corrente dele (Painitto FC) é a de sempre.
  ...
  C: [
    ...
    // 🌑🐺 Pesadelo Verde FC (portaltech.ep) entrou aqui em 18/09, por decisão do
    // Diego, na vaga do bot "Zé Colmeia". Save antigo com Zé Colmeia vira Pesadelo
    // Verde FC ao abrir (ver OLD_NAME). O bot CONTINUA existindo em CPU_MANAGERS —
    ...
    { name: 'Pantera', team: 'Pantera Negra FC' }, // 🐆👑 clube BATIZADO por apoiador (ericrabelo29 — Pantera Negra FC; o dono em uniforme de pantera, preto + dourado, bola-galáxia no pé; coração FLAMENGO, dito pelo Diego em 21/09 e gravado em `esc_socios.time_coracao`; Lenda + fundador nº74 + sócio nº55, 20/09). Assento que era do Miúdo EC. ⚠️ Isto aqui é memória do repo — no POST não se diz de quem era o assento (regra 05/09).
    ...
    // ⚽ O XURUPITAS FC desceu da Série A pra cá em 23/09, por decisão do Diego,
    // pra abrir a vaga do Fabulous EC. Ele pega o assento do bot "Mano Paulista",
    // que CONTINUA existindo em CPU_MANAGERS (o elenco do jogo rápido, outra lista).
...
export const CLASSIC_CLUBS: { name: string; atk: number; def: number }[] = [
  ...
  { name: 'Barcenite FC', atk: 70, def: 72 }, // ⚽ desceu da Série A em 10/09 (abriu o assento do Leite de Verdade FC) — MESMA força do bot que cedeu a vaga (Marítimo do Recôncavo)
