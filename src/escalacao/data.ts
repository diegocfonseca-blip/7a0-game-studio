...
const MEI: C[] = [
  ...
  { name: "Ademir da Guia", club: "Palmeiras", year: 1972, fame: 5, lo: 91, hi: 96 },
...
const GOL_EU: C[] = [
  ...
  { name: "Petr Čech", club: "Chelsea", year: 2005, fame: 5, lo: 87, hi: 93 },
  ...
  { name: "Edwin van der Sar", club: "Man United", year: 2009, fame: 5, lo: 88, hi: 94, bio: "O holandês gigante do United campeão da Champions — recorde de minutos sem tomar gol e frieza total nas decisões." },
...
const ZAG_EU: C[] = [
  ...
  { name: "Rio Ferdinand", club: "Man United", year: 2008, fame: 5, lo: 87, hi: 93 },
...
const MEI_EU: C[] = [
  ...
  { name: "Patrick Vieira", club: "Arsenal", year: 2001, fame: 5, lo: 88, hi: 94 },
...
const ATA_EU: C[] = [
  ...
  { name: "Eden Hazard", club: "Chelsea", year: 2015, fame: 5, lo: 89, hi: 95 },
