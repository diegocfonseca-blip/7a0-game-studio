...
const ZAG: C[] = [
  ...
  { name: "Mauro Galvão", club: "Vasco", year: 1997, fame: 4, lo: 80, hi: 88 },
...
const ATA: C[] = [
  ...
  { name: "Emerson Sheik", club: "Corinthians", year: 2012, fame: 3, lo: 74, hi: 84, bio: "Camisa 11 do Timão campeão da Libertadores e do Mundo em 2012 — decisivo no auge, artilheiro e ídolo." },
