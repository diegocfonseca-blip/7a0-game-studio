...
const MEI_EU: C[] = [
  ...
  { name: "David Beckham", club: "Man United", year: 1999, fame: 4, lo: 86, hi: 92, bio: "O rei da bola parada — cruzamento e falta milimétricos pela direita do United da tríplice coroa. Ícone dentro e fora de campo." },
...
export const DIVISION_TEAMS: Record<'A' | 'B' | 'C' | 'D', CareerTeam[]> = {
  ...
  A: [
    ...
    { name: 'Legado', team: 'Tricolor do Arruda' }, // ⚽ clube BATIZADO por apoiador (souzact12 — Tricolor do Arruda, ex-Legado EC; homenagem ao time do coração dele, Lenda + fundador nº43, 16/08)
