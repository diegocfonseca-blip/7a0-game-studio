...
export const BIOS: Record<string, string> = {
  ...
  'Rafael Moura': 'O He-Man. Centroavante faz-tudo, pesadelo do Flamengo e presença de área por quase 20 anos.',
...
const MEI: C[] = [
  ...
  { name: 'Rivaldo', club: 'Palmeiras', year: 1996, fame: 5, lo: 91, hi: 97 },
  ...
  { name: 'Marcelinho Carioca', club: 'Corinthians', year: 1995, fame: 2, lo: 64, hi: 86, folk: true },
  { name: 'Edílson', club: 'Corinthians', year: 1998, fame: 2, lo: 62, hi: 85 },
  { name: 'Petkovic', club: 'Fluminense', year: 2002, fame: 2, lo: 62, hi: 84, folk: true },
  ...
  { name: 'Arrascaeta', club: 'Flamengo', year: 2022, fame: 4, lo: 82, hi: 90 },
...
const ATA: C[] = [
  ...
  { name: 'Gabigol', club: 'Flamengo', year: 2019, fame: 4, lo: 82, hi: 90 },
