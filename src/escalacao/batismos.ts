...
export const BATISMOS: Batismo[] = [
  ...
  { clube: 'Stocco FC', tipo: 'batismo', fundador: 56 },
  { clube: 'Final Boss FC', tipo: 'batismo', fundador: 57 },
  { clube: 'Vidraceiro FC', tipo: 'batismo', fundador: 58 },
  { clube: 'Bagres 1993', tipo: 'batismo', fundador: 59 },
