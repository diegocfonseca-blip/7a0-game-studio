...
const FOUNDERS: Record<string, ApoioTier> = {
  ...
  'davisantana1312@gmail.com': 'ouro', // 👑 Lenda (pago) — tudo do ouro + FUNDADOR + batismo (Bicho da Seda, ex-Red Bull Diet)
  ...
  'danielmanfre5@gmail.com': 'ouro', // 👑 Lenda (pago) — tudo do ouro + FUNDADOR + batismo a definir (08/08)
}
...
const FUNDADOR_N: Record<string, number> = {
  ...
  'mickael.mearepresentacoes@gmail.com': 33,
