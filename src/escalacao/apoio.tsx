...
const FOUNDERS: Record<string, ApoioTier> = {
  ...
  'souzact12@gmail.com': 'ouro', // 👑 Lenda (pago) — tudo do ouro + FUNDADOR + batismo (Tricolor do Arruda, ex-Legado EC; cobra de cachimbo no escudo e de mascote; coração Santa Cruz) — era Craque prata, subiu no batismo (16/08)
...
const FUNDADOR_N: Record<string, number> = {
  ...
  'souzact12@gmail.com': 43, // 🖋️ batismo Tricolor do Arruda (ex-Legado EC, Série A) — cobra de cachimbo no escudo e de mascote (16/08)
}
