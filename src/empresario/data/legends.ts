...
export const SCOUT_REGIONS: Record<string, { label: string; flag: string; nationalities: Nationality[]; stars: string }> = {
  ...
  AF: { label: 'África', flag: '🌍', nationalities: ['LR', 'NG', 'CM'], stars: 'Weah, Okocha, Eto\'o' },
  LA: { label: 'América Latina', flag: '🌎', nationalities: ['CO', 'CL'], stars: 'Valderrama, Zamorano, Asprilla, Salas' },
}
